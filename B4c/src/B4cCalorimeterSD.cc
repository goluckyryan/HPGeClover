...
G4bool B4cCalorimeterSD::ProcessHits(G4Step* step, G4TouchableHistory* history)
{
  ...
  //
  //G4cout
  //  << "Theta : " << dir.getTheta() / degree << "  "
  //  << "Phi : " << dir.getPhi()  / degree   << "  "
  //<< G4endl;

  G4cout << "----------------B4cCalorimeterSD::ProcessHits " << G4endl;
...
//  if ( verboseLevel>1 ) { 
     ...
     G4cout
       << G4endl 
       //<< "B4cCalorimeterSD::EndOfEvent : " << fDetname  <<G4endl
