 ...
 : G4UserRunAction()
{
  ...
  // Creating histograms
  //
  analysisManager->CreateH1("h1","Energy (MeV) deposited in HPGe; MeV; count / 1 keV",7000,1.,8.); // ID = 1
  ...
  analysisManager->CreateNtupleDColumn("theta");    // column Id = 3
  analysisManager->CreateNtupleDColumn("phi");      // column Id = 4
  analysisManager->CreateNtupleDColumn("nVertex");      // column Id = 5
  analysisManager->CreateNtupleDColumn("e");      // column Id = 6
