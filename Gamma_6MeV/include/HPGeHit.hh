...
/// - the Crystal ID
/// - the particle time
/// - the Crystal logical volume, its position and rotation

class HPGeHit : public G4VHit
{
  public:
    HPGeHit(G4int i,G4double t);
    HPGeHit(const HPGeHit &right);
    virtual ~HPGeHit();

    const HPGeHit& operator=(const HPGeHit &right);
    G4bool operator==(const HPGeHit &right) const;
