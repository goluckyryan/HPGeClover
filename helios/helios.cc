...
int main(int argc,char** argv)
{
  ...
  runManager->SetUserInitialization(new HeliosDetectorConstruction());
  ...
  //runManager->SetUserInitialization(new HeliosPhysicsList);

  //Action Initialization  
  runManager->SetUserInitialization(new HeliosActionInitialization());
