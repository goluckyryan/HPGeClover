...
HeliosPrimaryGeneratorAction::HeliosPrimaryGeneratorAction()
...
void HeliosPrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
...
void HeliosPrimaryGeneratorAction::DefineCommands()
{
  // Define /Helios/generator command directory using generic messenger class
  fMessenger = new G4GenericMessenger(this, "/Helios/generator/", "Primary generator control");
